...
export const ReviewForm = (): JSX.Element => {
  ...
  const onRatingChange = (event: React.ChangeEvent<HTMLInputElement>) => setRating(Number(event.target.value));
  const onTextChange = (event: React.ChangeEvent<HTMLTextAreaElement>) => setText(event.target.value);
  ...
  return (
    <form className="reviews__form form" action="#" method="post">
      ...
      <textarea className="reviews__textarea form__textarea" id="review" name="review" onChange={onTextChange} placeholder="Tell how was your stay, what you like and what can be improved"></textarea>
